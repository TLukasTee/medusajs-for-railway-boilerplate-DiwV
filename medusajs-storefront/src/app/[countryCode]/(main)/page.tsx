...
import HeroCustom from "@modules/layout/HeroCustom"
...
<HeroBanner  />
        <ul className="flex flex-col gap-x-6 bg-white">
          <FeaturedProducts specificCollectionId="pcol_01J1WAE5YHJ4NM1CS3A8VKPNQZ" collections={collections} region={region} />
        </ul>
