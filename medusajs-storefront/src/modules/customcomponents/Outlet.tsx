...
const Outlet: React.FC = () => {
  return (
    <div className="bg-gray-200 rounded-2xl overflow-hidden md:mx-24 mb-12">
      <div className="flex flex-col md:flex-row  ">
        ...
        <div className="bg-gradient-to-r from-gray-200 to-black/10 p-6 md:w-1/2 flex flex-col justify-between">
          ...
          <div className="text-white mb-10">
            ...
            <button className="bg-red-600  text-white text-center flex justify-center items-center mx-auto text-black font-bold py-2 px-6 rounded-full hover:bg-yellow-400 transition duration-300">
