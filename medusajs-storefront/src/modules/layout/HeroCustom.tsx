        ...
        <div className="pb-80 pt-16 sm:pb-40 sm:pt-14 lg:pb-56 lg:pt-14 ">
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            <div className="sm:max-w-xl">
              ...
              <h1 className="text-4xl font-bold uppercase py-5 tracking-tighter sm:text-5xl md:text-6xl">
                  ...
                  <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8 pb-28">
                    <div className="flex items-center space-x-4 lg:space-x-4">
                      <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                        <div className="overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100 max-w-3xl pr-36">
                          <img
